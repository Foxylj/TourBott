...
# rate, data = wf.read('you-can-stay-at-home.wav')
# print(sum(data[0]))
# print(data.shape)

v = VoiceActivityDetector('you-can-stay-at-home.wav')
...
mfccs = librosa.feature.mfcc(y=result, sr=sample_rate)
print(mfccs.shape)
S = librosa.feature.melspectrogram(y=result, sr=sample_rate, n_mels=128,
                                   fmax=8000)
